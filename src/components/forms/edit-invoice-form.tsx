...
export function EditInvoiceForm({ invoice, lineItems: initialLineItems, onClose }: EditInvoiceFormProps) {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl my-4">
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Edit {invoice.invoice_number}</h2>
          </div>
